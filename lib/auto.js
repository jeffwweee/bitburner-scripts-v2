...
export async function main(ns) {
  ...
  while (true) {
    ...
    if (!target) {
      log(ns, "auto: no rooted money target found yet. Run lib/root.js or gain access to more servers.", Boolean(options.terminal));
...
function printHelp(ns) {
  ns.tprint("Usage: run lib/auto.js [TARGET] [--target HOST] [--strategy current|prep] [--rank] [--top N] [--tail] [--terminal]");
